...
const AboutSection = () => {
  ...
  return (
    <section id="about" className="py-20 bg-light-section-alt">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            {features.map((feature, index) => (
              <div key={index} className="flex items-start space-x-4 p-6 bg-white rounded-xl hover:bg-slate-50 border border-slate-200 shadow-sm transition-colors">
