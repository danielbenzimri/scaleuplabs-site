...
const mockProjects: Project[] = [
  ...
  {
    id: 'mock-2',
    title: "Intelligent Document Processing (Document AI)",
    description: "Developed an intelligent Document AI system using LLMs to extract, categorize, and summarize business documents with 95% accuracy.",
    tags: ["Document AI", "OpenAI API", "LangChain", "Node.js", "MongoDB"],
    icon: "Zap",
    image: "https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=800&h=400&fit=crop",
    category: "Generative AI",
    metrics: "10x faster document processing",
    detailedDescription: "This cutting-edge Document AI solution revolutionized document management for a Fortune 500 company. Our system can automatically process thousands of documents daily, extracting key information, categorizing content, and generating executive summaries.\n\nUsing advanced prompt engineering and fine-tuned language models, the system understands context and nuance in business documents, making it incredibly accurate for legal contracts, financial reports, and technical specifications.",
